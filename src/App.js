 ...
 render() {
  return (
    <div className="App">
       ...
       <h1 style={{ color: "red", fontSize: 60 }}>click here to show my profile bage</h1>
       <button onClick={this.handleshow}>click</button>

      {this.state.show &&
     <div>
       <img src={this.state.img} alt="ok"/>
       <h1>
